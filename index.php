...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Added class for direct attack targeting */
        ...
        .card-details-body { padding: 10px; display: flex; gap: 10px; min-height: 150px; }
        .detail-img { width: 80px; height: 116px; background-color: #111; background-size: cover; border: 1px solid #555; position: relative; }
        ...
        .detail-info { flex: 1; display: flex; flex-direction: column; gap: 5px; font-size: 11px; color: #ccc; }
        .info-row { display: flex; border-bottom: 1px solid #444; padding-bottom: 2px; min-height: 18px; }
        .info-label { width: 40px; color: var(--neon-blue); } .info-val { color: #fff; }
        .description-box { font-size: 10px; line-height: 1.2; color: #ddd; height: 60px; overflow-y: auto; margin-top: 5px; border: 1px solid #333; padding: 3px; background: rgba(0,0,0,0.3); }
        ...
        .hand-container { position: fixed; bottom: 15px; left: 0; width: 100%; display: flex; justify-content: center; gap: 5px; z-index: 200; padding-bottom: 10px; pointer-events: none; }
        .hand-card { width: 100px; height: 146px; background-size: cover; background-position: center; background-repeat: no-repeat; border-radius: 5px; border: 1px solid #555; box-shadow: -2px 2px 10px rgba(0,0,0,0.5); transition: transform 0.2s; cursor: pointer; background-color: #222; pointer-events: auto; }
        ...
        .player-zone { border: var(--zone-border-width) solid var(--neon-blue); } .player-zone::after { background: rgba(0, 212, 255, 0.05); box-shadow: 0 0 10px var(--neon-blue); }
        /* Targetable logic for battle */
        ...
        .phase-content { display: flex; align-items: center; width: 100%; justify-content: center; position: relative;}
        .phase-strip { height: 40px; background: linear-gradient(90deg, transparent 0%, rgba(0, 40, 60, 0.9) 20%, rgba(0, 40, 60, 0.9) 80%, transparent 100%); border-top: 1px solid var(--neon-blue); border-bottom: 1px solid var(--neon-blue); flex-grow: 1; display: flex; align-items: center; justify-content: center; color: #fff; font-weight: 700; letter-spacing: 4px; text-shadow: 0 0 10px var(--neon-blue); position: relative; box-shadow: 0 0 15px rgba(0, 212, 255, 0.3); transition: color 0.3s; }
        ...
        .card { width: 68px; height: 99px; border-radius: 4px; box-shadow: 0 3px 6px rgba(0,0,0,0.9); background-size: cover; background-position: center; background-repeat: no-repeat; position: relative; transform-style: preserve-3d; transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); display: flex; flex-direction: column; justify-content: flex-end; background-color: #222; }
        ...
        <div class="panel">
            ...
            <div class="card-details-body">
                ...
                <div class="detail-info">
                    <div class="info-row"><span class="info-label">Name</span><span class="info-val" id="detailName"></span></div>
